function Cart() {
    ...
    this.checkOut = function(cartName, cb) {
        console.log("Checkout event called for " + cartName);
        this.submitSuccess = cb;

        var send = {};
        this.postDataTo(send, "CheckOut", this.prime, cartName);
    };
};
...
function createCartconn()
{
    ...
    fsmart.flowName = 'PetstoreCartFlow';
    return fsmart;
}
