function GeoLocation() {
    ...
    this.listcallback = function(resp, smartobj) {
        ...
        if (resp instanceof smartresponse) {
            ...
            {
                smartobj.callback(lresp.list[i].values['location']);
            }
        }
    };
};

GeoLocation.prototype = new smart();


function createmessageconn()
{
    var fsmart = new GeoLocation();
    ...
    fsmart.flowName = 'GeoLocationFlow';
    return fsmart;
}
